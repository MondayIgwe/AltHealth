...
<head>
	<link rel="stylesheet" type="text/css" href="cssStyling/logoStyling.css"> 
        ...
        <link rel='stylesheet' id='PT+Sans-css'  href='https://fonts.googleapis.com/css?family=PT+Sans%3A1&#038;ver=4.9.10' type='text/css' media='all' />
        <link rel='stylesheet' id='PT+Serif-css'  href='https://fonts.googleapis.com/css?family=PT+Serif%3A1&#038;ver=4.9.10' type='text/css' media='all' />
</head>
<!-- body -->
    ...
    <center>
        ...
        <img src="images/logo.png" />
           ...
           <ul>
               ...
               <object width="200" height="200" align="center" data="helloworld.swf"><li style="margin-left: 2em"><a href="Client_ViewAppointments.php">Back</a></li></object>
              <object width="200" height="200" align="center" data="helloworld.swf"><li style="margin-left: 2em"><a href="index.php">Log out</a></li></object>
            </ul>
        </nav>
       </div>
      </center>
...
<div class="section mcb-section" id="Secondary" style="padding-top:0px; padding-bottom:0px; background-color:#dfecf0; background-image:url(https://www.samedicalwebsitedesign.co.za/wp-content/uploads/2018/06/secondary-page-background.png); background-repeat:no-repeat; background-position:left top; background-attachment" >
<div class="section_wrapper mcb-section-inner">
<div class="wrap mcb-wrap three-fourth secondary-text-container valign-top clearfix" style="" >
<div class="mcb-wrap-inner"><div class="column mcb-column one column_visual secondary-text">
        
<center>
   
<h1>Get in Touch</h1><p><div role="form" class="wpcf7" id="wpcf7-f4-p20-o2" lang="en-US" dir="ltr">
<div class="screen-reader-response"></div>
<form action="/contact/#wpcf7-f4-p20-o2" method="post" class="wpcf7-form" novalidate="novalidate">
...
<p><label> Contact Number<br />
    <input type="text" name="your-contact" value="" size="40" aria-invalid="false" /></label></p>
<p><label> Your Message<br />
    <textarea name="your-message" cols="40" rows="10"  aria-invalid="false"></textarea></label></p>
    <!--Send-->
    <p><input type="submit" name="submitContact" value="Send" 
    <p><?php 
        if(isset($_POST['submitContact']))
            {
              echo '<script type="text/javascript">';
              echo ' alert("Message has been received!")';
              echo '</script>';
              echo '<br>';
              echo '<br>';
            } 
...
<footer id="Footer" class="clearfix">	
	    <div class="widgets_wrapper" style="">
            ...
            <div class="textwidget custom-html-widget">
                <h5><b>Our Office Address:</b></h5>
	<tr>
	<td> Unit 495 The William Nicole & Broadacres, Johannesburg, South Africa, 2001
        </td>
        </tr>
</body>
</form>	
